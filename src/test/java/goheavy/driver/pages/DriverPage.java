...
public class DriverPage extends PageObject {
	...
	String form;
	String fullName;
	By editIconLocator = By.xpath("//span[@role='img' and @class='anticon anticon-edit']");
	By titleLocator = By.xpath("//span[contains(@class,'iaAGQP')]");
	...
	public boolean clicksOnEdit() {
		waitForSpinningElementDisappear();
			clickOnElement(editIconLocator);
			return true;
	}

	public void showEditView() {
		Assert.assertEquals("Edit Driver view not found","Edit Driver",getWebElement(titleLocator).getText());
		Assert.assertTrue("First Name is empty",!getElement("firstName").getAttribute("value").trim().isEmpty());
	}
}
